      ...
      <div className="grid lg:grid-cols-2 gap-8 p-4">
        ...
        <div className="p-8 lg:p-12 flex flex-col items-center justify-center text-center space-y-6">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link to="/individualpricing"><button className="inline-flex items-center px-6 py-3 bg-[#0F1B4C] text-white font-semibold rounded-md hover:bg-[#1a2b6d] transition-colors">
              Try Now
            </button></Link>

...
const Hero = () => {
  return (
    <>
      <div 
        className="mx-auto max-w py-48 md:px-10 bg-cover bg-center"
      ...
      >
        <div className="mx-auto mb-8 w-full max-w-3xl text-center md:mb-12 lg:mb-16">
          ...
          <p className="mx-auto mb-5 max-w-lg text-sm text-gray-500 sm:text-xl md:mb-6 lg:mb-8">
            Get productivity apps, security, and storage with OSquare.
          </p>
          {/* Hero Button */}
        ...
        <div className="flex justify-center mb-16">
          <div className="flex justify-center items-center space-x-4 bg-white p-4 rounded-full shadow-md">
            ...
            <Link className='relative px-6 py-3 rounded-full font-medium text-sm transition-all duration-200' to='/business'>For Business</Link>
            ...
            <Link className='bg-[#172554] text-white relative px-6 py-3 rounded-full font-medium text-sm transition-all duration-200' to='/'>For Individual</Link>
          </div>
        </div>
      </div>
    </>

...
export default function Form() {
  ...
  const ischoolplans = {
    ...
    parents_profile_management: { icon: <img src="/modules/parents-profile-management.png" alt="parents profile management" width={100} />, title: "Parents' Profile Management", price: 8 },
    admissions: { icon: <img src="/modules/admissions.png" alt="admissions" width={100} />, title: "Admissions", price: 8 },
    fee_management: { icon: <img src="/modules/fee_management.png" alt="fee_management" width={100} />, title: "Fee Management", price: 8 },
    ...
    students_online_attendance: { icon: <img src="/modules/students-online_attendance.png" alt="students online attendance" width={100} />, title: "Students' online Attendance", price: 8 },
    ...
    progress_report: { icon: <img src="/modules/progress_report.png" alt="progress report" width={100} />, title: "Progress Report", price: 8 },
  ...
  const ischoolformeplans = {
    notice_board: { icon: <img src="/modules/notice_board.png" alt="notice board" width={100} />, title: "Notice Board", price: 8 },
    attendance: { icon: <img src="/modules/attendance.png" alt="attendance" width={100} />, title: "Attendance", price: 8 },
          ...
          <div className="container mx-auto px-4 flex items-center justify-between gap-6 ">
            ...
            <div className="flex flex-col items-end">
              <p className="text-lg font-medium mb-4 text-black">
                Total: {calculateTotal() > 0 ? `$${calculateTotal().toFixed(2)}` : "N/A"}
              </p>
              <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-5">
          {Object.keys(iteamplans).map((plan) => (
            <div
              ...
              onClick={() => handlePlanSelect(plan, selectediteamPlans, setSelectedhr360Plans)}
            >
